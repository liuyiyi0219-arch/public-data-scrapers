...
| [SEC EDGAR Filing Monitor](https://apify.com/lxraa/edgar-filing-monitor) | SEC EDGAR full-text search | 10-K/10-Q/8-K/S-1 by keyword / form / date → JSON + links, **mapped to stock tickers** |
| [US Federal Spending Monitor](https://apify.com/lxraa/usaspending-monitor) | USAspending.gov | Federal contracts & grants by keyword / agency → JSON, **recipients mapped to tickers** |
...
- [Map SEC filings & federal contracts to stock tickers (exact, free)](guides/05-map-records-to-stock-tickers.md)

## Who these are for

- **Healthcare / pharma / CRO** — clinical trial tracking.
- **Finance / research** — SEC filing search and monitoring.
- **Quant / alternative data** — public records mapped to stock tickers for signals.
